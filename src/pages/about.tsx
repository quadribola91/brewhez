      ...
      <main className="px-6 py-16 max-w-6xl mx-auto">
        ...
        <section className="text-center mb-20">
          ...
          <p className="text-lg text-gray-500 max-w-3xl mx-auto p-8">
            Were passionate about brewing joy in every cup. Our coffee shop is more than just beans and brews— its a community hub where people connect, relax, and recharge. Every latte, espresso, and smile is crafted with care.
          </p>
        </section>
